    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form method="POST" action="{{ route('vet.clinics.update', $clinic) }}" class="space-y-4">
                    @csrf @method('PUT')
                    ...
                    <div class="flex items-center gap-2 pt-2">
                        <input type="checkbox" name="is_public" id="is_public" value="1" {{ old('is_public', $clinic->is_public) ? 'checked' : '' }} class="w-4 h-4 rounded border-gray-300 text-teal-600 focus:ring-teal-500">
