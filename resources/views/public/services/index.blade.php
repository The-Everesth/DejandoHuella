                    ...
                    @forelse($clinics as $clinic)
                        <div class="bg-white rounded-lg shadow hover:shadow-lg transition">
                            <div class="p-6">
                                ...
                                <!-- View details button -->
                                <a href="{{ route('clinics.show', $clinic->id) }}" class="block w-full text-center bg-teal-700 text-white px-4 py-2 rounded-lg hover:bg-teal-800 transition font-medium">
                                    Ver detalles
                                </a>
                            </div>
                        </div>
